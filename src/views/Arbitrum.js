  ...
  return (
    <div className="Home">
      ...
      <div className="chart-grid">
        ...
        <div className="chart-cell">
          <ChartWrapper title="AUM & Olp Supply" loading={glpLoading} data={glpData} csvFields={[{ key: 'aum' }, { key: 'glpSupply' }]}>
        ...
        <div className="chart-cell">
          ...
          >
            ...
            <div className="chart-description">
              <p>
                <span style={{ color: COLORS[0] }}>% of Index (with fees)</span> is Olp with fees / Index Price * 100. Index is a basket of 25% BTC, 25% ETH, 50% USDC rebalanced once&nbsp;a&nbsp;day
                <br />
                <span style={{ color: COLORS[4] }}>% of LP ETH-USDC (with fees)</span> is Olp Price with fees / LP ETH-USDC * 100<br />
              </p>
            </div>
          </ChartWrapper>
        </div>
        <div className="chart-cell">
          ...
          >
            ...
            <div className="chart-description">
              <p>
                <span style={{ color: COLORS[3] }}>Olp with fees</span> is based on OLP share of fees received and excluding esCHARM rewards<br />
