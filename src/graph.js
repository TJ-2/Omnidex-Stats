...
const arbitrumStatsClient = new ApolloClient({
  link: new HttpLink({ uri: 'http://207.154.248.98:8000/subgraphs/name/perpetuals-stats', fetch }),
...
const arbitrumPricesClient = new ApolloClient({
  link: new HttpLink({ uri: 'http://207.154.248.98:8000/subgraphs/name/perpetuals-prices', fetch }),
  cache: new InMemoryCache(),
  defaultOptions: apolloOptions
})
