...
const providers = {
  arbitrum: new JsonRpcProvider('https://testnet.telos.net/evm'),
...
export const tokenSymbols = {
  // Arbitrum
  '0xA9F175d3eEB1483d8Ad31D38b5673C951720C49a': 'BTC',
  '0x2433D3c00128d1B5C2D241bFAA61aFD6b22810D6': 'ETH',
  '0xaE85Bf723A9e74d6c663dd226996AC1b8d075AA9': 'LINK',
  '0x7456Dd35C2FD863C7Aa917E6A46dBF9192ca6B70': 'USDC',
  '0x929eE3B7cbD7331bb9ac8659CDe7157bCBB0A6a2': 'USDT',
...
const knownSwapSources = {
  arbitrum: {
    '0x4e278A6f7C362789cD549113EAe522eFd0207D7D': 'GMX Router', // Router
    '0x05eB37FdAd9dD7192de07cFfdcdAFEF7f93E4b2A': 'GMX OrderBook', // Orderbook
    '0xb1B972c0409BEcE77d55FAa1473e5b5E2EfED86e': 'GMX PositionManager A', // PositionManager old
    '0xb1B972c0409BEcE77d55FAa1473e5b5E2EfED86e': 'GMX PositionManager B', // PositionManager
    '0xb1B972c0409BEcE77d55FAa1473e5b5E2EfED86e': 'GMX PositionManager C', // PositionManager 12 oct 2022
    '0xB5dD80E7AA0bBea56c1D672a0F3C9EE95dd03334': 'GMX PositionRouter C', // PositionRouter 12 oct 2022
    '0x7257ac5d0a0aac04aa7ba2ac0a6eb742e332c3fb': 'GMX OrderExecutor', // OrderExecutor ???
    '0x0e93B4C4b6B4701d62f83C375a47FE49Eb8296D8': 'GMX FastPriceFeed A', // FastPriceFeed
...
function getChainSubgraph(chainName) {
  return chainName === "arbitrum" ? "perpetuals-stats" : "perpetuals-stats"
}
...
export function useGraph(querySource, { subgraph = null, subgraphUrl = null, chainName = "arbitrum" } = {}) {
  ...
  if (!subgraphUrl) {
    ...
    subgraphUrl = `http://207.154.248.98:8000/subgraphs/name/${subgraph}`;
  }
